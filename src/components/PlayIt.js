...
const PlayIt = (props) => {
  ...
  return (
    ...
    props.play&&<div>
    <iframe className="my-video"src={`${props.play}`} frameborder="0" allow="accelerometer; autoplay; clipboard-write; encrypted-media; gyroscope; picture-in-picture" allowfullscreen="allowfullscreen"></iframe>
